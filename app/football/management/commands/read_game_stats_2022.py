...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        GameStats.objects.filter(game__dt__gte="2022-07-01",game__dt__lte="2023-07-01").delete()
        r = requests.get("https://www.pro-football-reference.com/years/2022/games.htm")
        sleep(6)
        box_score_links = []
        z = r.text.split('",\n\t\t\t"url": "')
        for y in z[1:]:
